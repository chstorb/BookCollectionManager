namespace BCM.DAL.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.BcmBookCategories", "CategoryId", "dbo.BcmCategory");
            DropForeignKey("dbo.BcmBookCategories", "BookId", "dbo.BcmBook");
            DropForeignKey("dbo.BcmBookAuthors", "AuthorId", "dbo.BcmAuthor");
            DropForeignKey("dbo.BcmBookAuthors", "BookId", "dbo.BcmBook");
            DropIndex("dbo.BcmBookCategories", new[] { "CategoryId" });
            DropIndex("dbo.BcmBookCategories", new[] { "BookId" });
            DropIndex("dbo.BcmBookAuthors", new[] { "AuthorId" });
            DropIndex("dbo.BcmBookAuthors", new[] { "BookId" });
            ...
            DropTable("dbo.BcmBookCategories");
            DropTable("dbo.BcmBookAuthors");
