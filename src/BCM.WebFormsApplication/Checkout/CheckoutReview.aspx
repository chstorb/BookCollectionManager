<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CheckoutReview.aspx.cs" Inherits="BCM.WebFormsApplication.Checkout.CheckoutReview" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="OrderItemList" runat="server" AutoGenerateColumns="False" GridLines="Both" CellPadding="10" Width="500" BorderColor="#efeeef" BorderWidth="33">
        <Columns>
            ...
            <asp:BoundField DataField="Product.Title" HeaderText=" Book Title" />
            <asp:BoundField DataField="Product.ListPrice" HeaderText="Price (each)" DataFormatString="{0:C}" />
